...
const SERVER_ONLY_SIGNING_ENV_KEYS = new Set([
...
export function isForbiddenConfigEnvKey(key: string): boolean {
  return key === "PAPERCLIP_API_KEY" || SERVER_ONLY_SIGNING_ENV_KEYS.has(key);
}
...
export async function runChildProcess(
  ...
  return new Promise<RunProcessResult>((resolve, reject) => {
    ...
    for (const key of SERVER_ONLY_SIGNING_ENV_KEYS) {
