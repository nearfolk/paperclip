...
export function registerIssueCommands(program: Command): void {
  ...
  addCommonClientOptions(
    issue
      ...
      .requiredOption("--source-issue-status <status>", "todo, done, or in_review for restored outcomes; backlog preserves intentional backlog only with cancelled; blocked is only valid with blocked")
